...
def main():
    ...
    # load task datasets
    tasks = dict({'echo_high_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/EchoNet-Dynamic/EchoNet-Dynamic',
                                                        device=device,
                                                        max_frames=30,
                                                        nth_frame=1,
                                                        task='high_risk_ef'),
                  'echo_medium_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/EchoNet-Dynamic/EchoNet-Dynamic',
                                                          device=device,
                                                          max_frames=30,
                                                          nth_frame=1,
                                                          task='medium_ef_risk'),
                  'echo_slight_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/EchoNet-Dynamic/EchoNet-Dynamic',
                                                          device=device,
                                                          max_frames=30,
                                                          nth_frame=1,
                                                          task='slight_ef_risk'),
                  'echo_normal_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/EchoNet-Dynamic/EchoNet-Dynamic',
                                                     device=device,
                                                     max_frames=30,
                                                     nth_frame=1,
                                                     task='normal_ef')})
