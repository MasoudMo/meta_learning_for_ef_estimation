...
def main():
    ...
    # load task datasets
    tasks = dict({'echo_ap4_high_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/echonet',
                                                            device=device,
                                                            max_frames=30,
                                                            nth_frame=1,
                                                            task='high_risk_ef'),
                  'echo_ap4_medium_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/echonet',
                                                              device=device,
                                                              max_frames=30,
                                                              nth_frame=1,
                                                              task='medium_ef_risk'),
                  'echo_ap4_slight_risk_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/echonet',
                                                              device=device,
                                                              max_frames=30,
                                                              nth_frame=1,
                                                              task='slight_ef_risk'),
                  'echo_ap4_normal_ef': EchoNetEfDataset(dataset_path='D:/Workspace/RCL/datasets/raw/echonet',
                                                         device=device,
                                                         max_frames=30,
                                                         nth_frame=1,
                                                         task='normal_ef'),
                  'lv_biplane_ap2_high_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                    image_shape=128,
                                                                    device=device,
                                                                    raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                    task='high_risk_ef',
                                                                    view='ap2'),
                  'lv_biplane_ap4_high_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                    image_shape=128,
                                                                    device=device,
                                                                    raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                    task='high_risk_ef',
                                                                    view='ap4'),
                  'lv_biplane_ap2_medium_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                      image_shape=128,
                                                                      device=device,
                                                                      raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                      task='medium_ef_risk',
                                                                      view='ap2'),
                  'lv_biplane_ap4_medium_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                      image_shape=128,
                                                                      device=device,
                                                                      raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                      task='medium_ef_risk',
                                                                      view='ap4'),
                  'lv_biplane_ap2_slight_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                      image_shape=128,
                                                                      device=device,
                                                                      raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                      task='slight_ef_risk',
                                                                      view='ap2'),
                  'lv_biplane_ap4_slight_risk_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                      image_shape=128,
                                                                      device=device,
                                                                      raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                      task='slight_ef_risk',
                                                                      view='ap4'),
                  'lv_biplane_ap2_normal_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                 image_shape=128,
                                                                 device=device,
                                                                 raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                 task='normal_ef',
                                                                 view='ap2'),
                  'lv_biplane_ap4_normal_ef': LVBiplaneEFDataset(dataset_path='D:/Workspace/RCL/datasets/preprocessed/biplane_lvef',
                                                                 image_shape=128,
                                                                 device=device,
                                                                 raw_data_summary_csv='Biplane_LVEF_DataSummary.csv',
                                                                 task='normal_ef',
